...
// //! use crate::{DomainSeparator, ProverState, DuplexSpongeInterface, ProofResult};
// //! use crate::backend::arkworks::*;
// //!
...
// //! Now the proving function can be called with [`crate::DigestBridge<sha2::Sha256>`][`crate::DigestBridge`].
// //! As easy as that.
...
// // Re-export domain_separator traits needed by arkworks
// pub use crate::domain_separator::traits::{
//     ByteDomainSeparator, BytesToUnitDeserialize, BytesToUnitSerialize,
//     CommonUnitToBytes, UnitToBytes, UnitTranscript,
// };

// pub use crate::{
//     duplex_sponge::Unit, codecs::*, domain_separator::DomainSeparator, DuplexSpongeInterface,
