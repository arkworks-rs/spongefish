...
// NOTE: deliberately no `usize` impl — a `usize`-alphabet sponge would produce
// platform-dependent transcripts (32- vs 64-bit targets).
...
/// ([`Shake128`][crate::instantiations::dsfs::Shake128],
/// [`TurboShake128`][crate::instantiations::dsfs::TurboShake128]) this is the
