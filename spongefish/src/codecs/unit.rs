...
use crate::{
    transcript::{InteractionError, Label, PatternError},
    Unit,
};
    ...
    U: Unit,
{
    ...
    fn ratchet(&mut self) -> Result<(), PatternError>;
    fn public_unit(&mut self, label: impl Into<Label>) -> Result<(), PatternError>;
    fn public_units(&mut self, label: impl Into<Label>, size: usize) -> Result<(), PatternError>;
    fn message_unit(&mut self, label: impl Into<Label>) -> Result<(), PatternError>;
    fn message_units(&mut self, label: impl Into<Label>, size: usize) -> Result<(), PatternError>;
    fn challenge_unit(&mut self, label: impl Into<Label>) -> Result<(), PatternError>;
    fn challenge_units(&mut self, label: impl Into<Label>, size: usize)
        -> Result<(), PatternError>;
    fn hint_bytes(&mut self, label: impl Into<Label>, size: usize) -> Result<(), PatternError>;
    fn hint_bytes_dynamic(&mut self, label: impl Into<Label>) -> Result<(), PatternError>;
}
    ...
    U: Unit,
{
    ...
    fn challenge_unit(&mut self, label: impl Into<Label>) -> Result<U, InteractionError>
    where
        U: Default,
    {
    ...
    U: Unit,
{
    ...
    fn message_unit(&mut self, label: impl Into<Label>, value: &U) -> Result<(), InteractionError>;
    ...
    U: Unit,
{
    ...
    fn message_unit(&mut self, label: impl Into<Label>) -> Result<U, InteractionError>
    where
        U: Default,
    {
        let mut result = U::default();
    ...
    fn hint_bytes(
        ...
        label: impl Into<Label>,
        size: usize,
    ) -> Result<&'a [u8], InteractionError>;

    fn hint_bytes_dynamic(&mut self, label: impl Into<Label>)
        -> Result<&'a [u8], InteractionError>;
}

// Implementations are directly in [`TranscriptRecorder`], [`ProverState`] and [`VerifierState`].
