...
//! XOFs such as SHAKE and KangarooTwelve. BLAKE3 keeps a dedicated wrapper in
//! [`instantiations::Blake3`] because its optional digest integration currently
//! targets a different digest generation.
//!
